...
public class BookAppMain extends JFrame{
 private javax.swing.JButton jButton1;
   ...
   String d = df.format(new Date());
    ...
    if(name.equals("") && contact.equals("") && age.equals(""))
{
    JOptionPane.showMessageDialog(null," please fill the form completely");
     ...
     jButton1.addActionListener(new ActionListener(){
            @Override
             public void actionPerformed(java.awt.event.ActionEvent e) {
                 int p=JOptionPane.showConfirmDialog(null,"Do you really want to Submit","Submitted",JOptionPane.YES_NO_CANCEL_OPTION);
            if (p==0)
                    {
             String name=jTextField1.getText();
            String contact=jTextField2.getText();
